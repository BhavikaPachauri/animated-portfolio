  ...
  return (
    <div ref={containerRef} className="relative w-full py-20 overflow-hidden" style={{ minHeight: "600px" }}>
      ...
      >
        ...
        <path className="draw-path" d="M0 500 H150 L200 450 H400 V350 H600 V500 H800 L850 450 H1200" stroke="#00ff41" strokeWidth="1" />
        {/* Nodes */}
        ...
        <path className="draw-path" d="M0 200 L300 400 L600 200 L900 400 L1200 200" stroke="#00ff41" strokeWidth="0.5" />
        {/* Grid crosses */}
        ...
        <path className="draw-path" d="M600 150 L600 170 M590 160 L610 160" stroke="#00ff41" strokeWidth="1" />
      </svg>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full min-h-[500px] px-6">
        ...
        <h2 className="text-[clamp(2rem,6vw,5rem)] font-bold tracking-[-0.04em] leading-[1] text-center" style={{ fontFamily: "var(--font-display)" }}>
          ...
          <span style={{ color: "#00ff41" }}>Matrix</span>
        </h2>
