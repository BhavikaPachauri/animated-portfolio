  ...
  return (
    <div ref={containerRef} className="relative w-full py-20 overflow-hidden" style={{ minHeight: "600px" }}>
      ...
      >
        ...
        <path className="draw-path" d="M100 100 V200 H300 V400 H500 V150 H700 V350 H900 V100" stroke="#00ff41" strokeWidth="1" />
        <path className="draw-path" d="M0 500 H150 L200 450 H400 V350 H600 V500 H800 L850 450 H1200" stroke="#c4a1ff" strokeWidth="1" />
        {/* Nodes */}
        <path className="draw-path" d="M200 300 m-8,0 a8,8 0 1,0 16,0 a8,8 0 1,0 -16,0" stroke="#00ff41" strokeWidth="1.5" />
        <path className="draw-path" d="M500 300 m-8,0 a8,8 0 1,0 16,0 a8,8 0 1,0 -16,0" stroke="#00ff41" strokeWidth="1.5" />
        <path className="draw-path" d="M750 200 m-8,0 a8,8 0 1,0 16,0 a8,8 0 1,0 -16,0" stroke="#c4a1ff" strokeWidth="1.5" />
        <path className="draw-path" d="M950 300 m-8,0 a8,8 0 1,0 16,0 a8,8 0 1,0 -16,0" stroke="#00ff41" strokeWidth="1.5" />
        {/* Diagonal lines */}
        <path className="draw-path" d="M300 0 L600 300 L900 0" stroke="#00ff41" strokeWidth="0.5" strokeDasharray="4 4" />
        <path className="draw-path" d="M0 200 L300 400 L600 200 L900 400 L1200 200" stroke="#c4a1ff" strokeWidth="0.5" />
        {/* Grid crosses */}
        <path className="draw-path" d="M400 250 L400 270 M390 260 L410 260" stroke="#00ff41" strokeWidth="1" />
        <path className="draw-path" d="M800 350 L800 370 M790 360 L810 360" stroke="#00ff41" strokeWidth="1" />
        <path className="draw-path" d="M600 150 L600 170 M590 160 L610 160" stroke="#c4a1ff" strokeWidth="1" />
      </svg>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full min-h-[500px] px-6">
        ...
        <h2 className="text-[clamp(2rem,6vw,5rem)] font-bold tracking-[-0.04em] leading-[1] text-center" style={{ fontFamily: "var(--font-display)" }}>
          <span style={{ color: "#00ff41" }}>Building</span>{" "}
